...
public class JoyStick : MonoBehaviour
{
    ...
    private void Init()
    {
        transform.localScale = new Vector3(SettingManager.Instance.SettingData.JoyStickScale, SettingManager.Instance.SettingData.JoyStickScale, 1);
        _canvasGroup.alpha = SettingManager.Instance.SettingData.JoyStickAlpha;
        _canvasGroup.interactable = SettingManager.Instance.SettingData.JoyStickInteractable;
        _fixJoyStickPosition = SettingManager.Instance.SettingData.JoyStickFixPosition;
